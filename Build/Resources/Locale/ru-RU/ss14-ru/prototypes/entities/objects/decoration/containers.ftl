...
ent-ShippingContainerNanotrasen = грузовой контейнер Orienta
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображен логотип компании Orienta, и поэтому внутри может быть что угодно.
