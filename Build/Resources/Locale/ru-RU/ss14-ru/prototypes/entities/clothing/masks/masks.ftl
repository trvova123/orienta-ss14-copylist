...
ent-ClothingMaskGasCaptain = противогаз капитана
    .desc = В Orienta решили срезать углы и перекрасить запасной атмос-противогаз, только никому об этом не говорите.
ent-ClothingMaskGasHoP = противогаз капитана
    .desc = В Orienta решили срезать углы и перекрасить запасной атмос-противогаз, только никому об этом не говорите.
