...
ent-ClothingOuterHardsuitSyndie = кислотно-жёлтый скафандр
...
ent-ClothingOuterHardsuitSyndieCommander = скафандр командира синдиката
    .desc = Кислотно-жёлтый скафандр, серьезно модифицированный для использования командирами оперативных отрядов.
